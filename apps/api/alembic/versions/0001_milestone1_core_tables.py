...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status", ingestion_status_enum, nullable=False, server_default="queued"
        ),
        sa.Column(
            "metadata",
    ...
    op.create_index(
        "ix_documents_collection_id", "documents", ["collection_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status", ingestion_job_status_enum, nullable=False, server_default="queued"
        ),
